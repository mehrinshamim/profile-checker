...
class ImageMetadataPIIAnalyzer:
    ...
    def __init__(self):
        ...
        # Network-related fields that sometimes appear in maker notes
    ...
    def extract_all_metadata(self, image_bytes):
        """Extract all possible metadata from image bytes"""
        try:
            ...
            # Check for additional metadata sources
    ...
    def analyze_gps_data(self, exif_data: Dict) -> List[Dict]:
        """Analyze GPS information for privacy risks"""
        findings = []
        ...
        if 'GPSInfo' in exif_data and isinstance(exif_data['GPSInfo'], dict):
            ...
            # Check for altitude (can be sensitive for certain locations)
    ...
    def analyze_temporal_data(self, exif_data: Dict) -> List[Dict]:
        """Analyze timestamp and temporal information"""
        findings = []
    ...
    def analyze_device_information(self, exif_data: Dict) -> List[Dict]:
        """Analyze device and equipment information"""
        findings = []
    ...
    def analyze_user_content(self, exif_data: Dict, additional_info: Dict = None) -> List[Dict]:
        """Analyze user-generated content and comments"""
        findings = []
        
        # Text fields that might contain personal information
        text_fields = {
        ...
        for field, description in text_fields.items():
            ...
            if content and content.strip():
                # Analyze content for personal information patterns
    ...
    def analyze_network_information(self, exif_data: Dict, additional_info: Dict = None) -> List[Dict]:
        """Check for network-related information in metadata"""
        findings = []
        
        # Combine all text fields for network analysis
    ...
    def analyze_comprehensive_pii(self, image_bytes) -> Dict:
        """Main function to perform comprehensive PII analysis on image bytes"""
        try:
            ...
            return {
                ...
                'exif_data': exif_data  # Include original EXIF data for compatibility
            }
